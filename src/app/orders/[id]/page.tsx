        ...
        <div className="flex flex-col h-[calc(100vh-180px)] items-center justify-center">
            ...
            <div className="mt-12 flex flex-col gap-6">
                ...
                <div className="">
                    ...
                    <span className="">{order.billingInfo?.contactDetails?.firstName + " "}  {order.billingInfo?.contactDetails?.lastName} </span>
                </div>
                <div className="">
                ...
                <div className="">
                    ...
                    <span className="">{order.billingInfo?.address?.addressLine1 + " "} {order.billingInfo?.address?.city} </span>
                </div>
            </div>
